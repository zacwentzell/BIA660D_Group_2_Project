...
intended_checkboxes = ['Bose', 'Audio-Technica', '509316']
...
def scrape_reviews(item,product_name):
    ...
    try:
        ...
        Product_information_table = driver.find_element_by_id("detailBullets")
    ...
    while ( True ):
        ...
        try:
            ...
            print("The reviews on page 1 successfully extraced")
            onePageFlag = True
...
while(True):
    ...
    if (next_page == None):
        ...
        print("-------------------------------------------------")
        break
    next_page.find_elements_by_css_selector('*')[1].click()
    delay(5)
